...
Você também pode dar likes em heróis e criar sua lista personalizada, onde você pode adicionar e remover facilmente (mesmo que você saia da página sua lista de favoritos é mantida).
- Responsivo.
- Utilizando a criação de componentes separados para reutilização.
